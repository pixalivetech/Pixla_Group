    ...
    <div className="bg-[#f2F2F2]  flex flex-col items-center px-6 md:px-24  py-16">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-22 max-w-10xl">
          {divisions.slice(0, 4).map((item, index) => (
            <div
              ...
              className={`w-[220px] h-[260px] md:w-[250px] md:h-[280px]  border border-black bg-gradient-to-b ${item.gradient}
        ...
        <div
          ...
          className={`w-[220px] h-[260px] md:w-[250px] md:h-[280px]  border border-gray-200 bg-gradient-to-b ${divisions[4].gradient}
