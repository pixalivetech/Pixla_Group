    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl">
        <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4">
          NDIA'S LARGESTSKILLING & PLACEMENT COMPANY
        </h1>
        <p className="text-base md:text-lg mb-6 text-gray-200">
          Pixlas Acadmy offers training,internship, and placement to
          helps students and professionals build successful teach careers
        </p>
