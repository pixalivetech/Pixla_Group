...
const ProductCategories = () => {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 text-gray-800 relative -ml-20 sm:-ml-20 lg:-ml-40">
    ...
    <div className="relative pr-4 sm:pr-8 flex flex-col gap-6">
      ...
      {/* Beverages */}
      <div>
        <h3 className="text-lg text-gray-500 font-semibold mb-2">Beverages</h3>
      ...
      {/* Wellness Products */}
      <div className="pt-4">
        <h3 className="text-lg text-gray-500 font-semibold mb-2">Wellness Products</h3>
        <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base leading-relaxed">
    ...
    <div className="pl-4 sm:pl-8">
      <h3 className="text-lg text-gray-500 font-semibold mb-2">Groceries</h3>
      <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base leading-relaxed">
