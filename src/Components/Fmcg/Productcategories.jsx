...
const ProductCategories = () => {
  return (
    <section className="bg-[#f2f2f2] px-6 md:px-24 py-16 md:py-24">
      {/* Section Title */}
      <div className="inline-block border-b-2 border-gray-500 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="relative pr-4 sm:pr-8 flex flex-col gap-6">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base leading-relaxed">
                <li>
                  Popular and refreshing brands: Pixlare, Fidaa, ClearUp,
                  Mangozaa, Cokmak
                </li>
            ...
            <div className="pt-4">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base leading-relaxed">
                <li>
                  Health-focused products to support well-being and lifestyle
                </li>
                <li>
                  Includes supplements, nutritional beverages, and daily
                  essentials
                </li>
                <li>
                  Delivered through retail, e-commerce, and B2B channels
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="pl-4 sm:pl-8 mt-6 sm:mt-0">
            <h3 className="text-lg text-gray-500 font-semibold mb-2">
              Groceries
            </h3>
            <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base leading-relaxed">
