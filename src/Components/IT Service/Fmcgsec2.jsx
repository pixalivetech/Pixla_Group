...
import Fmcgimg2 from "./../../assets/It/It2.png"
       ...
       <section className="bg-[#f6f6f6] px-6 md:px-24 py-16">
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           ...
           <div className="bg-white  shadow-md p-6 md:p-8 flex flex-col justify-center">
             <h2 className="text-3xl font-semibold text-gray-900 mb-4">#Services</h2>
             <ul className="list-disc list-inside text-black space-y-2 font-semibold text-base">
