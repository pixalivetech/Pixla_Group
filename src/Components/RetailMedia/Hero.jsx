...
const PixlaGroup = () => {
  return (
    <section className="bg-[#f2f2f2] px-4 sm:px-6 md:px-16 lg:px-24 py-12 md:py-16">
      {/* Top Section */}
      ...
      <div className="relative mt-10">
        ...
        <div className="absolute inset-0 flex items-end justify-between px-4 sm:px-6 md:px-8 pb-6">
          {/* Text Box */}
          <div className="p-3 sm:p-4 text-white bg-black/30 backdrop-blur-sm shadow-lg ">
      ...
      <div className="flex flex-col md:flex-row items-start mt-10 gap-4 md:gap-6">
        ...
        <p className="md:w-1/2 text-gray-600 text-sm sm:text-base leading-relaxed md:max-w-2xl">
          A trusted partner for leading brands, offering multi-platform
          engagement, data-driven solutions, and expertise in digital marketing,
          retail activations, and omnichannel campaigns.
        </p>
      </div>
    </section>
  );
